...
const initialData = [
  { name: 'Aarya Patel', city: 'Ahmedabad', state: 'Gujarat', usage: 80 },
  { name: 'Ravi Kumar', city: 'Bhubaneswar', state: 'Odisha', usage: 85 },
  { name: 'Sara Khan', city: 'Mumbai', state: 'Maharashtra', usage: 90 },
